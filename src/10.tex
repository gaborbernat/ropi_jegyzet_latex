...
%		\draw (0,0) node[vertex] (1){} 	.. controls ++(288:1cm) and ++(0:1cm) .. (1){};
	...
	\end{scope}
\end{tikzpicture}
\caption{Elhagyás és összehuzás művelet grafikus matroidban}\label{fig:ElhagyOssze}
\end{figure}


Az elagyások és az összehúzás műveletek prioritása azonos, tehát felcserélhető. $M$ matroid 
