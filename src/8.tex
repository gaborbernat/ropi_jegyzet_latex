...
\begin{tikzpicture}[scale=3]
    ...
    \filldraw[fill=green!40, draw=green] (6mm,0) circle (1.5mm) node[black, anchor=mid]{c};
 	\filldraw[fill=red!40, draw=red]  (3.5mm,0) circle (1.5mm) node[black,anchor=mid]{b};
 	\filldraw[fill=blue!40, draw=blue]  (1.0mm,0) circle (1.5mm) node[black,anchor=mid]{a};
	\end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1]
  ...
  \draw[-] (3) -- (1) node [midway, above] {$\beta$};
\end{tikzpicture} 
& $
\begin{cases}
X=(a,b), &r(X)=2 \\ 
