...
A minimumos egyenlet megoldása a maximum egyenlet megoldásának az ellentéte lesz.
...
visszavezetjük $n-1$ változóra, iteratívan, amíg egy változós egyenletrendszert nem kapunk;
