...
\begin{tikzpicture}[scale=0.7]
  ...
  \node[p] (A) at (-1.54, 1.02) {$A$};
  \node[p,minimum width=1.4cm] (D) at (0, 1.02) {$D$};
  \node[p,minimum width=2.1cm] (G) at (2.52, 1.02) {$G$};
  
  \node[p] (B) at (-1.54, 0) {$B$};
  \node[p,minimum width=1.4cm] (E) at (0, 0) {$E$};
  \node[p,minimum width=2.1cm] (H) at (2.52, 0) {$H$};
  
  \node[p] (C) at (-1.54, -1.02) {$C$};
  \node[p,minimum width=1.4cm] (F) at (0, -1.02) {$F$};
  \node[p,minimum width=2.1cm] (I) at (2.52, -1.02) {$I$};
  ...
  \node[p] (Ao) at (6.98, 1.02) {$A$};
  \node[p,minimum width=1.4cm] (Do) at (8.5, 1.02) {$D$};
  \node[p] (Bo) at (10.02, 1.02) {$B$};
  
  \node[p,minimum width=2.12cm] (Ho) at (7.99, 0) {$H$};
  \node[p] (Co) at (10.02, 0) {$C$};
  
  \node[p,minimum width=2.12cm] (Io) at (7.99, -1.02) {$I$};
  \node[p,minimum width=1.4cm] (Eo) at (10.52, -1.02) {$E$};
  
  \node[p,minimum width=1.4cm] (Fo) at (12.54, -1.02) {$F$};
  \node[p,minimum width=2.1cm] (Go) at (15.06, -1.02) {$E$};
