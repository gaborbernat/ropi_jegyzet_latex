...
\begin{tikzpicture}
	...
	\begin{scope}[opacity=0.8]
		\filldraw[fill=green!40, draw=green] (0,0) ellipse (2cm and 1.5cm) ;
		\filldraw[fill=red!40, draw=red] (2cm,0) ellipse (1.8cm and 1.2cm) ;
	\end{scope}
	\draw  (-1cm, 0) node[color=green!40!black]{$1-\epsilon$};
	\draw  (1cm, 0) node[color=green!50!red]{$1$};
	\draw  (2.5cm, 0) node[color=red!40!black]{$1$};
